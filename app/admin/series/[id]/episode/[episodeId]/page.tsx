...
import { updateEpisode, getSeriesById, getEpisodesBySeriesId, type Series, type Episode } from "@/lib/db-actions"
...
export default function EditEpisodePage() {
      ...
      try {
        ...
        if (episode) {
          setFormData({
            ...
            richContent: episode.richContent || episode.content,
  ...
  if (!series) {
    return <div className="text-center py-12 text-gray-500">Series not found</div>
  }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">Editing episode in: {series.name}</p>
        </CardHeader>
        <CardContent>
